          ...
          {projects.map((prj) => {
            ...
            return (
              <div
                ...
                className="flex-shrink-0 w-80 p-4 rounded-lg border border-zinc-250 dark:border-zinc-800 dark:bg-zinc-950 cursor-pointer transform hover:-translate-y-0.5 hover:shadow-md hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-300 flex flex-col justify-between space-y-4 shadow-[0_1px_3px_rgba(0,0,0,0.02)]"
              >
                <div>
                  {/* Status header */}
                ...
                <div className="grid grid-cols-2 gap-2 border-t border-zinc-200 dark:border-zinc-800 pt-3 text-center">
                  ...
                  <div className="flex flex-col space-y-0.5 border-l border-zinc-200 dark:border-zinc-800">
                    <span className="text-[8px] font-black text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Job Margin</span>
